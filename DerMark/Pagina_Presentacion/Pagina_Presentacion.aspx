<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Pagina_Presentacion.aspx.cs" Inherits="DerMark.Pagina_Presentacion" %>
       ...
       <%-- <div class="jumbotron">
            <div class="container">
                ...
                <div class="input-group mb-3">
                    <input type="text" class="form-control" placeholder="Buscar Food" aria-label="Recipient's username" aria-describedby="basic-addon2">
        ...
        <%--<div class="location-match text-xs-center">
            <div class="container">
                 <span>356 restaurants matched your location: <span class="primary-color">New York, NY -</span> </span>
            </div>
        </div>--%>
                            ...
                            <div class="restaurant-block">
                                <div class="left">
                                    <a class="pull-left" href="profile.html">
                                        <img src="http://placehold.it/50x46" alt="Restaurant logo" />
                                    </a>
            ...
            <div class="container">
                ...
                <div class="row top-footer">
                    <div class="col-xs-12 col-sm-3 footer-logo-block color-gray">
                        <a href="#">
                            <img src="images/food-picky-logo.png" alt="Footer logo">
                        </a><span>Order Delivery &amp; Take-Out </span>
                    </div>
